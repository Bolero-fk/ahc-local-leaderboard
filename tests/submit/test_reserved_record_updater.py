...
def test_update_reserved_record(
    ...
    mock_record_read_service.fetch_detail_records.return_value = mock_detail_records
    ...
    mock_record_read_service.fetch_detail_records.assert_called_once_with(mock_reserved_record.id)
