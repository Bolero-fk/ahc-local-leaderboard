...
def update_score_history_with_relative_diff(non_latest_record, relative_score_diff):
...
def update_relative_score(relative_score_calculator):
    ...
    for non_latest_record in non_latest_records.records:
        total_relative_score_diff = calculate_total_relative_score_diff(relative_score_calculator, non_latest_record, updated_top_scores)
...
def update_relative_rank(latest_record):
...
def update_lower_ranks(latest_record):
